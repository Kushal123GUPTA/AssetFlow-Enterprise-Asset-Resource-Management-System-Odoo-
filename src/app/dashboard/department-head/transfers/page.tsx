...
export default function DepartmentTransfersPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      className: "whitespace-normal break-words leading-tight text-gray-300",
      ...
      <div className="space-y-6 max-w-7xl text-white">
        ...
        >
          <div className="space-y-3 py-3">
            <p className="text-sm text-gray-400">Please provide a reason for rejecting this transfer request:</p>
            <Input.TextArea
              rows={4}
              value={rejectReason}
