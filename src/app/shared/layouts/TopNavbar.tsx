...
export default function TopNavbar() {
  ...
  return (
    <header className="h-20 flex items-center justify-between px-8 bg-white border-b border-gray-800 shrink-0 sticky top-0 z-30 shadow-sm shadow-gray-800/10">
      ...
      <div className="flex items-center gap-4">
        ...
        <button className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-gray-50 hover:bg-gray-100 text-gray-400 hover:text-primary transition-all">
          <Bell className="w-4 h-4" />
          <span className="absolute top-2 right-2 w-2 h-2 bg-primary rounded-full ring-1 ring-white" />
        </button>

        {/* Profile Info Widget */}
        <div className="flex items-center gap-2 text-sm text-gray-600 border-l border-gray-800 pl-4">
